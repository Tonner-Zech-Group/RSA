...
For this tutorial you can use the coordinates of MSA from the [Molecule Library](@ref). The largest part of the main input file is identical to previous tutorials: 
```
